...
const g7 = createNewGame(WORLD_TEAMS.find(t => t.tag === 'TES')!.id, '审计经理', 20260824)
setupSeason(g7)
...
const g8 = createNewGame(WORLD_TEAMS.find(t => t.tag === 'DKC')!.id, '审计经理', 20260824)
setupSeason(g8)
...
const g9 = createNewGame(WORLD_TEAMS.find(t => t.tag === 'TES')!.id, '审计经理', 20260824)
setupSeason(g9)
