...
const hasLocalData = (): boolean => {
  try {
    return !!localStorage.getItem('lolmanager:save:autosave') || !!localStorage.getItem('lolmanager:card:id')
  } catch { return false }
}

const cardId = (): string | null => {
  try { return localStorage.getItem('lolmanager:card:id') } catch { return null }
}
